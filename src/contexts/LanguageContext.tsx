...
const translations = {
  it: {
    ...
    contactPhone: '339 3321170',
    contactWhatsapp: 'Scrivici su WhatsApp',
    contactEmail: 'miccolisvincenzo50@gmail.com',
    companyVAT: 'P.IVA',
    companyVATNumber: '08525850726',
    companyCode: 'Codice Univoco',
    companyCodeNumber: 'USAL8PV',
    companyInfoDescription: 'Dati fiscali dell\'azienda',
    ...
    copyright: '© 2025 Edil Miccolis. Tutti i diritti riservati.',
  ...
  en: {
    ...
    companyCodeNumber: 'USAL8PV',
    companyInfoDescription: 'Company tax information',
    ...
    copyright: '© 2025 Edil Miccolis. All rights reserved.',
    privacyPolicy: 'Privacy Policy',
